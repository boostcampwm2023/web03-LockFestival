...
export class SecretGardenEscapeCrawler extends AbstractCrawler {
  BASE_URL = 'http://secretgardenescape.com/reservation.html';
  zizumMap = {
    '다운타운 홍대': 2,
    '서면점': 3,
    '대학로점': 4,
...
export const SecretGardenEscapeCrawlerMetadata = {
  brandName: '비밀의 화원',
  crawlerClass: SecretGardenEscapeCrawler,
};
